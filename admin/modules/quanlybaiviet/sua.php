...
?>
<p style="font-size: 20px;">Sửa bài viết</p>
...
.select {
 ...
 <form method="POST" action="modules/quanlybaiviet/xuly.php?idbaiviet=<?php echo $row['id'] ?>" enctype="multipart/form-data">
	  ...
	  <tr>
	   ...
	   <tr>
	    <td colspan="2"><input type="submit" name="suabaiviet" value="Sửa bài viết" id="submit"></td>
	  </tr>
 </form>
 <?php
 } 
...
<div class="return">
  <a href="index.php?action=quanlybaiviet&query=them"><i class="fas fa-chevron-left"></i>&ensp;Quay lại </a>
</div>
<?php
    require('../../../front/carbon/autoload.php');
	...
	if(isset($_GET['code'])){
		$code_cart = $_GET['code'];
		$sql_update ="UPDATE cart SET cart_status=1 WHERE code_cart='".$code_cart."'";
		$query = mysqli_query($mysqli,$sql_update);

		//thong ke doanh thu
        $sql_lietke_dh = "SELECT * FROM cart_details,sanpham WHERE cart_details.id_sanpham=sanpham.id_sanpham AND cart_details.code_cart='$code_cart' ORDER BY cart_details.id_cart_details DESC";
